...
namespace Teknosib.Business.ValidationRules.AddressRules
{
    public class UpdateAddressDtoValidator : AbstractValidator<UpdateAddressDto>
    {
        ...
        {
            // Country - Required, MaxLength 300
            RuleFor(a => a.Country)
                .NotEmpty().WithMessage("Ülke bilgisi boş geçilemez.")
                .MaximumLength(300).WithMessage("Ülke bilgisi en fazla 300 karakter olabilir.");

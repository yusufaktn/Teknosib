...
namespace Teknosib.Business.ValidationRules.ProjectRules
{
    public class CreateProjectDtoValidator : AbstractValidator<CreateProjectDto>
    {
        public CreateProjectDtoValidator()
        {
            ...
            // Funder ID - Optional (nullable)
            // Funder opsiyonel olduğu için özel bir validasyon gerekmiyor
            ...
            // Project Status - Enum validation (optional since it has default value)
